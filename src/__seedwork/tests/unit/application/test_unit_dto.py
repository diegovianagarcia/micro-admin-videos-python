...
from __seedwork.application.dto import (
    Filter, Item,
    PaginationOutput, PaginationOutputMapper, SearchInput
)
from __seedwork.domain.repositories import SearchResult


class TestSearchInputUnit(unittest.TestCase):
...
class TestPaginationOutputUnit(unittest.TestCase):
...
class TestPaginationOutputMapperUnit(unittest.TestCase):
